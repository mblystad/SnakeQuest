...
class Game:
    ...
    def draw_hud(self):
        banner_height = DEFAULT_FONT.get_height() + 14
        banner_rect = pygame.Rect(0, 0, SCREEN_WIDTH, banner_height)
        pygame.draw.rect(self.screen, (0, 0, 0), banner_rect)
        ...
        padding = 12
        self.screen.blit(time_text, (padding, padding // 2))
        self.screen.blit(score_text, (SCREEN_WIDTH // 2 - score_text.get_width() // 2, padding // 2))
        self.screen.blit(level_text, (SCREEN_WIDTH - level_text.get_width() - padding, padding // 2))
